...
if($imgsi<=1000000){
$path= $folder.$image;
$q="insert into users(FirstName,LastName,Cnic,Email,Image,DateOfBirth,Password,Contact,Company,RoleId) values ('$f','$l','$c','$e','$path','$DOB','$p','$cont','$comp','$roid')";
$result=mysqli_query($con,$q);
move_uploaded_file($imgtn,$path);
if($result)
{
echo "<script> alert('done'); window.location.href='register.php';</script>";
}
else
{
