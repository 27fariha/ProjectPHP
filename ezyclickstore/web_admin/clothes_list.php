...
<body>
  <?php include("include2/header.php");?>
	...
	<h1>Jewellery list / Page <?php echo $page;?> </h1></div><br>
...
<tr><th>Product ID</th><th>Image</th><th>Name</th><th>Price</th><th>
	...
	<a class=" btn btn-primary" href="jewellery_pdf.php" target="_blank">Download Jewellery PDF</a>
</th></tr>
<?php 

$result=mysqli_query($connection,"select product_id,image, product_name,price from products  where product_type like '%dress%' order by rand()")or die ("query 1 incorrect.....");

while(list($product_id,$image,$product_name,$price)=mysqli_fetch_array($result))
{
echo "<tr><td>$product_id</td><td><img src='../images/products/$image' style='width:50px; height:50px; border:groove #000'></td><td>$product_name</td>
<td>$price</td>
<td>
