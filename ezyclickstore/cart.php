...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Cart |EzyClick Store</title>
...
echo "<h1 style='color:#0C0'>Succesfull &nbsp;&nbsp;  <span class='glyphicon glyphicon-ok'></h1></span>";
}
?></h1>
...
ini_set( "display_errors", 0); //warnings and notices remover
$cartOutput="";
if(!isset($_SESSION["cart_array"]) || count ($_SESSION["cart_array"])<1)
{
	$cartOutput="<h2 align='center'> Your shopping cart is empty</h2>";
	...
	//query
	$results=mysqli_query($connection,"select product_id, product_name,image,price,details from products where product_id ='$item_id' Limit 12");
...
//Total amount code below:
	$Total = array_sum($price);
//Total ka table row
	echo "
<table align='right'>
	<tr>
	<td class='cart_total' style='border:1px solid silver; font-size:18; font-weight:bold:'>
<p style='color:black;display: inline;font-size:30px;'>Total: </p><p class='cart_total_price' style='display: inline;' >$Total</p>
    </td>
	</tr>
	</table>"
	;

//Total amount table end
     

//Total amount by The Great Azan Ahmed
