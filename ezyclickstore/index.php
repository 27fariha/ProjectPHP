...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Home |EzyClick Store</title>
...
<!-- <li data-target="#slider-carousel" data-slide-to="2" class="active"></li> -->
		...
		<div class="item">
		<div class="col-sm-6">
<h1><span>EzyCLick</span>-Store</h1>
<h2>Cosmetics</h2>
<p>EzyCLick Store offers you only one Brand products in Cosmetics "Oriflame". Like 'Skin Care, Beauty Care, Facial Products & Nail Art'
</p>
...
<p>Women’s Jewellery offered by EzyCLick Store is ideal for all occasions, seasons and moods, such as: Weddings, Eid, Parties, Casual Gatherings, and anything else you can possibly imagine.</p>
<a href="jewellery.php" class="btn btn-default get">Get it now
</a>
		</div>
		<div class="col-sm-6">
<img src="images/jewel4.jpg" class="girl img-responsive" alt="">
		</div>
		</div>
		</div>
...
<h4 class="panel-title"><a href="#">WOMENS</a></h4></div></div>
...
href="#sportswear">
	...
	<div class="panel-heading">
		 ...
		 <div class="panel panel-default">
		 <div class="panel-heading">
<h4 class="panel-title"><a href="cosmetics.php">Facial Products</a></h4>
		 </div></div>
		 <div class="panel panel-default">
		 <div class="panel-heading">
<h4 class="panel-title"><a href="cosmetics.php">Skin Care</a></h4>
		 </div></div>
		 <div class="panel panel-default">
		 <div class="panel-heading">
<h4 class="panel-title"><a href="cosmetics.php">Beauty care</a></h4>
		</div></div>
		
		<div class="panel panel-default">
		<div class="panel-heading">
<h4 class="panel-title"><a href="cosmetics.php">Nail Art</a></h4>
		</div></div>

		 <div class="panel panel-default">
		 <div class="panel-heading">
<h4 class="panel-title"><a href="jewellery.php">Rings</a></h4>
		</div></div>

				 <div class="panel panel-default">
		 <div class="panel-heading">
<h4 class="panel-title"><a href="jewellery.php">Necklaces</a></h4>
		</div></div>

				 <div class="panel panel-default">
		 <div class="panel-heading">
<h4 class="panel-title"><a href="jewellery.php">Earrings</a></h4>
		</div></div>
...
<li><a href="link_form.php?link=oriflame"><img src="images/brands/pandora.png" style="width:200px"></a></li>
<li><a href="link_form.php?link=nishat"><img src="images/brands/ForgeJewelry.svg" style="width:200px"></a></li>
  <li><a href="link_form.php?link=mariab"><img src="images/brands/bella.png" style="width:200px"></a></li>
<li><a href="link_form.php?link=gul ahmed"><img src="images/brands/xj.jpg" style="width:200px"></a></li>
<li><a href="link_form.php?link=jj"><img src="images/brands/alex.png" style="width:200px"></a></li>
   
  <li><a href="link_form.php?link=sana safinaz"><img src="images/brands/rj.png" style="width:200px"></a></li>
   <li><a href="link_form.php?link=sobia nazir"><img src="images/brands/eagle.png" style="width:200px"></a></li>
   
  <li><a href="link_form.php?link=alkaram"><img src="images/brands/charlote.jpg" style="width:200px"></a></li>
<li><a href="link_form.php?link=crescent"><img src="images/brands/urban.png" style="width:200px"></a></li>
<li><a href="link_form.php?link=asim jofa"><img src="images/brands/maybe.png" style="width:200px"></a></li>
<li><a href="link_form.php?link=khaadi khadi"><img src="images/brands/loreal.png" style="width:200px"></a></li>
<li><a href="link_form.php?link=orient"><img src="images/brands/chanel.png" style="width:200px"></a></li>
<li><a href="link_form.php?link=elan"><img src="images/brands/cover.png" style="width:200px"></a></li>
<li><a href="link_form.php?link=motifz"><img src="images/brands/feel.png" style="width:200px"></a></li>
   </ul>
...
<h2 class="title text-center">New Items</h2>
		<?php 
$cosmetics=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products  where product_type like '%dress%' order by rand()")or die("Query 1 is inncorrect..........");
