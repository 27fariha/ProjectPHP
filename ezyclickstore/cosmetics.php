...
<h4 class="panel-title"><a href="#">Facial Products</a></h4>
		 </div></div>
		 <div class="panel panel-default">
		 <div class="panel-heading">
<h4 class="panel-title"><a href="#">Skin Care</a></h4>
		 </div></div>
		 <div class="panel panel-default">
		 <div class="panel-heading">
<h4 class="panel-title"><a href="#">Beauty care</a></h4>
		</div></div>
		
		<div class="panel panel-default">
		<div class="panel-heading">
<h4 class="panel-title"><a href="#">Nail Art</a></h4>
		</div></div>
...
<h2>Brands</h2>
   ...
   <li><a href="link_form.php?link=oriflame"><img src="images/brands/chanel.png" style="width:180px"></a></li>
   <li><a href="link_form.php?link=oriflame"><img src="images/brands/maybe.png" style="width:180px"></a></li>
...
<h2 class="title text-center">Cosmetics Items</h2>
	<?php 
$cosmetics=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products where product_type like '%cosmetics%' order by rand()")or die("Query 1 is inncorrect..........");
