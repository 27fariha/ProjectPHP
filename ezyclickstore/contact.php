...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Contact |EzyClick Store</title>
...
echo "<h1 style='color:#0C0'>Your message has been sent successfully &nbsp;&nbsp;  <span class='glyphicon glyphicon-ok'></h1></span>";
}
?>			 		
			</div>    	
    		<div class="row">  	
