...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Product Details |EzyCLick Shop</title>
...
$product_details_id = $_GET['id'];
 $product_details = mysqli_query($connection,"select product_id,  product_name,details,brand, image, price, c_price from products where product_id ='$product_details_id'")or die("Query 1 is inncorrect..........");
 list($pro_id,$product_name,$details,$brand,$image,$price,$c_price)= mysqli_fetch_array($product_details);
}
 ?>
 <div class="col-sm-5">
	...
	<img src="<?php echo"images/products/$image";?>" alt="">
		...
		<input type="number" min="1" max="6" value="quantity" name="quantity">
		<label>Limit: 6</label>
		</span>
		<p><b>Brand:</b><?php echo"$brand";?></p> <br/><br/><br/>

				<a href='link_cart.php?id=<?php echo"$pro_id";?>&' class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>  
