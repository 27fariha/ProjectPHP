...
include('connect.php');
$id=$_GET['a'];
$q="select * from quartly where ID='$id'";
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Quaterly Update Form</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="qid" value="<?php echo $data['ID']; ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="quater" value="<?php echo $data['Quater']; ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
...
$que="update quartly set Quater='$quater',  CompID='$companyid'  ,Date='$date' 
 where ID='$id'";
$res=mysqli_query($con,$que);
if($res){
echo "<script>alert('Updated'); window.location.href='listquaterly.php'; </script>";
}
else{
