    ...
    <div style="margin:5%" >
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="insertmonthly.php">
...
?>
                        ...
                        <div>
                            <button style="background-color: orange" class="btn btn--radius-2 btn--red" type="submit" name="monthlysubmit" >Submit</button>
                        </div>
                    </form>
                </div>
            </div>
