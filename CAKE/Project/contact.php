        ...
        <div class="col-lg-3">
            <div class="contact_info">
                ...
                <div class="info_item">
                    ...
                    <h6><a href="#">support@sahar.com</a></h6>
...
if(isset($_POST["btn"]))
{
    ...
    $q="INSERT INTO contact(name,email,subject,message) VALUES('$n','$e','$s','$m')";
    $run=mysqli_query($con,$q);
    if($run){
        echo "<script> alert('Thank You For Contacting Us We`ll be contact you soon..!!!');</script>";
    }
    else{
