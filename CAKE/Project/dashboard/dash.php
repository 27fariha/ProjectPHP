...
<body>
    ...
    *********************************************************************************************************************************************************** -->
        ...
        <header class="header black-bg">
            ...
            <!--logo start-->
<a href="" class="logo"><b style="color:#f299be"> CAKE <span style="color:#cf298c"> RESERVATION </span></b></a>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href=""><img src="assetsdashboard/img/e.png" class="img-circle" width="80"></a></p>
          <h5 class="centered">Sahar Mushtaq</h5>
                    <ul class="mt">
                    </ul>
                    <li class="sub-menu"style="color:white">
                        <a href="javascript:;">
                            <i class="fa fa-address-book"></i>
                            <span style="color:white"><b>Admin</b></span>
                        </a>
                        <ul class="sub">
                            <li style="color:white"><b><a href="adminread.php">View  Admin</a></b></li>
                             <li style="color:white"><b><a href="admin.php">Add Admin</a></b></li>
		 <li style="color:white"><b><a href="adminedit.php">Edit Admin</a></b></li>
                    ...
                    <li class="sub-menu" style="color:white">
                        ...
                        <ul class="sub">
                            ...
                            <li style="color:white"><b><a href="order.php">Add Order</a></b></li>
