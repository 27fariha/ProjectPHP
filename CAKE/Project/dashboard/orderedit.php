...
include ('connect.php');
$Id=$_GET['id'];
$qu="SELECT * FROM order WHERE Id=$Id";
...
<div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="lastname" name="lastname" min="2" max="50" type="number" required />
...
$g=$_POST["Delivery_date"];
      ...
      $q="update order set Name ='$a',Address='$b',Contact='$c',Itemcode='$d',Quantity='$e',Delivery_address='$j',Delivery_date='$g' where Id='$Id'";
