                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="./UserLogin.php">
                        <div class="input-group">
                            <input pattern="^[A-Za-z]+\s?[A-Za-z]+" class="input--style-3" type="text" placeholder="Username" name="un" required>
                        </div>
                         <div class="input-group">
                            <input class="input--style-3" type="Password" placeholder="Password" name="pd" required>
                        </div>
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" name='log'>Login</button>
                        </div>

                         <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" name='subb' href="reg_form.php">Create New Acount</button>
                        </div>
                    </form>
                </div>
            </div>
