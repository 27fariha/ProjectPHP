    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="reg_form.php" class="nav-link">Register</a></li>
          <li class="nav-item"><a href="contact.php" class="nav-link">Contact</a></li>
            <li class="nav-item"><?php if ($_SESSION['ABC']!=null){ 
      ...
      <div class="card card-3">
        ...
        <div class="card-body">
          ...
          <form method="POST">
            ...
            <div class="input-group">
              <input  class="input--style-3" type="text" placeholder="CNIC" name="cnic">
            </div>

            <div class="input-group">
              <input p class="input--style-3" type="text" placeholder="Contact" name="phone">
            </div>
            <div class="p-t-10">
...
if(isset($_POST['sub']))
{
  ...
  $q="INSERT into contact (User_name,email,Pswrd,cnic,contact) VALUES ('$name','$email','$password','$cnic','$contact')";
