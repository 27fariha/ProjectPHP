 ...
 <div class="container">
  <div class="row">
    ...
    while ($data=mysqli_fetch_assoc($rows))
    {
      ...
      <div class='img rounded d-flex align-items-end' style='background-image: url(../dashboard/$data[Pic]);'>
      </div>
      <div class='text'>
      <h2 class='mb-0'><a href='car-single.php'>".$data['Car_name']."</a></h2>

      <p class='d-flex mb-0 d-block'><a href='services.php?idd=".$data['Id']."' class='btn btn-primary py-2 mr-1'>".$data['rent_price']."<br>Car for Rent</a>
      <a href='pricing.php?idd=".$data['Id']."' class='btn btn-secondary py-2 ml-1'>".$data['Price']."<br>Car for Sale</a>
      </div>
      </div>
      </div>";
    }
...
</footer><footer class="ftco-footer ftco-bg-dark ftco-section">
  <div class="container">
    <div class="row mb-5">
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
